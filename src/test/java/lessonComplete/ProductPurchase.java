...
public class ProductPurchase extends Loginfunction {
	...
	public ProductPurchase() throws MalformedURLException {
	 ...
	 @When("^Login to Curoprox application$")
	    public void login_to_curoprox_application() throws Throwable {
	       super.loginfun();
	    }
	 ...
	 @Then("^Click on search box and search product Brush and select and product and click on it$")
		...
		// driver.pressKey(new KeyEvent(AndroidKey.ENTER));
		 driver.manage().timeouts().implicitlyWait(250, TimeUnit.SECONDS);
		 driver.findElementByAndroidUIAutomator("text(\"Toothbrush ATA\")").click();
		 driver.manage().timeouts().implicitlyWait(250, TimeUnit.SECONDS);
		 driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"Toothbrush ATA\"));");
		 driver.findElementByAndroidUIAutomator("text(\"Toothbrush ATA\")").click();
	    }
