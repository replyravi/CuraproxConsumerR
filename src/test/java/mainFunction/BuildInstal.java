...
public class BuildInstal extends Capab{
    ...
    public void click_curaprox_consumer_build_number() throws Throwable {
    	...
    	driver.findElement(By.xpath ("//android.widget.TextView[@bounds='[308,624][367,645]']")).click(); // Change which Build Number You Want to Install
    ...
    public void instal_the_build() throws Throwable {
    	...
    	driver.manage().timeouts().implicitlyWait(300, TimeUnit.SECONDS);
    	driver.findElementByAndroidUIAutomator("text(\"curaprox-app-consumer-1.0.211.apk\")").click();// Change which Build Number You Want to Install
