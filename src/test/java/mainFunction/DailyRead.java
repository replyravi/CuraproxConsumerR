...
public class DailyRead extends Loginfunction  {
	    ...
	    public void click_on_See_All() throws Throwable {
	    	driver.manage().timeouts().implicitlyWait(300, TimeUnit.SECONDS);
	    	driver.findElementByAndroidUIAutomator("text(\"DAILY READ\")").getText();
	    	driver.findElement(By.xpath ("//android.widget.TextView[@bounds='[931,1016][1038,1064]']")).click();
	    ...
	    public void click_on_daily_read_see_all_button_and_click_on_article_click() throws Throwable {
	    	driver.manage().timeouts().implicitlyWait(300, TimeUnit.SECONDS);
	    	//driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"3 reasons why brushing gently is better than brushing hard\"));");
	    	driver.findElementByAndroidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"3 reasons why brushing gently is better than brushing hard\").instance(0))");
	    	driver.manage().timeouts().implicitlyWait(300, TimeUnit.SECONDS);
	    	driver.findElementByAndroidUIAutomator("text(\"3 reasons why brushing gently is better than brushing hard\")").click();
	    }
