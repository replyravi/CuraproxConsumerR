...
public class StepDefinationsHomepageOpenlink extends Base {
	...
	public StepDefinationsHomepageOpenlink() throws MalformedURLException {}
	 ...
	 @Given("^Select South Africa$")
	    ...
	    @Given("^Click on Dental Professional$")
	    public void Click_on_Dental_Professional() throws Throwable {
	    	
	    	driver.manage().timeouts().implicitlyWait(300, TimeUnit.SECONDS);
	    	
	    	driver.findElementByAndroidUIAutomator("text(\"Dental Professional\")").click();
